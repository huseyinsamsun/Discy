...
namespace Discy.Common.Infrastructure
{
    public static class QueueFactory
    {
        ...
        {
            var factory = new ConnectionFactory() { HostName=DiscyConstants.RabbitMQHost };
            var connection=factory.CreateConnection();
            var channel = connection.CreateModel();
            return new EventingBasicConsumer(channel);

        }
        public static EventingBasicConsumer EnsureExchange(this EventingBasicConsumer consumer, string exchangeName, string exchangeType = DiscyConstants.DefaultExchangeType)
        {
